  ...
  "en-US": {
    "account": {
      ...
      "recoveryPhrase": {
        ...
        "remove": {
          ...
          "mnemonic": {
            "description": "It shares the same recovery phrase as {{walletName}}. Your recovery phrase will remain stored until you delete all remaining wallets."
          }
        },
        "subtitle": {
    ...
    "dapp": {
      "request": {
        "approve": {
          "action": "Approve",
          "fallbackTitle": "Approve spending tokens",
          "helptext": "Allow this site to access and spend this token from your wallet.",
          "label": "Wallet",
          "title": "Approve spending {{tokenSymbol}}"
        },
        "base": {
          "title": "Confirm transaction"
        },
        "changeChain": {
          "title": "Switch network to {{network}}"
        },
        "connect": {
          "helptext": "Allow this site to view your wallet address, balance, and request approvals for transactions.",
        ...
        "permit2": {
          "description": "Permit2 manages token approvals across multiple dapps.",
          "header": "Sign Permit2",
          "price": "None"
        },
        "signature": {
          "containsUnrenderableCharacters": "This message contains unrenderable characters. Make sure you trust this site.",
          "error": {
            "712-spec-compliance": "SignTypedDataRequestContent received data for signing which does not comply with the EIP-712 spec."
          },
          "header": "Signature request",
          "toggleDataView": {
            "raw": "View raw data",
            "readable": "View original data"
          }
        },
        "warning": {
          "notActive": {
    ...
    "extension": {
      "connection": {
        "popup": "Your wallet isn’t connected to this site. Look for a “Connect Wallet” or “Log in” button.",
        "popupWithButton": "Your wallet isn’t connected to this site.",
      ...
      "warning": {
        "storage": {
          "button": "Back up",
          "message": "Make sure to back up your recovery phrase to prevent losing access to your wallet and funds.",
          "title": "Your browser is running out of storage"
        }
      }
    },
    "fiatOnRamp": {
      ...
      "connection": {
        ...
        "terms": "By continuing, you acknowledge that you’ll be subject to the Terms of Service and Privacy Policy with {{serviceProvider}}, as applicable."
      },
      "error": {
      ...
      "quote": {
        "advice": "You’ll continue to the provider’s portal to see the fees associated with your transaction.",
        "others": "others",
        "type": {
          "other": "Other options",
    ...
    "home": {
      ...
      "banner": {
        "extension": {
          "confirm": "Join Beta",
          "message": "Be the first to try out the Uniswap Extension on your web browser",
          "title": "Uniswap Extension is here"
        },
      ...
      "modal": {
        "getExtension": {
          "step1": "1. Visit <highlight>uniswap.org/ext</highlight> on your computer",
          "step2": "2. Add the Uniswap Extension on your Chrome browser",
          "step3": "3. Enter your username to get access",
          "title": "Join the Uniswap Extension Beta"
        }
      },
      "nfts": {
        "title": "NFTs"
    ...
    "onboarding": {
      ...
      "complete": {
        "button": "Open Uniswap Wallet",
        "description": "Your wallet is ready to swap, send, and receive crypto.",
        "pin": {
          "description": "Click on the puzzle icon in your toolbar and find Uniswap Wallet in the list",
          "title": "Pin Uniswap Wallet"
        },
      ...
      "extension": {
        ...
        "getOnTheBetaWaitlist": {
          "subtitle": "Download the mobile app to claim a username",
          "title": "Get on the Beta waitlist"
        },
        "password": {
      ...
      "introBetaWaitlist": {
        ...
        "checkEligibilityInstructions": "Enter your <highlight>uni.eth</highlight> username below to check if you’re eligible for the Beta.",
        "eligible": {
          "tagline": "Welcome to the Beta — you’re one of the first to try out the Uniswap Extension.",
          "title": "You’re off the waitlist!"
        },
        "ineligibleExplanation": "You’re still on the waitlist. We’ll notify you in the Uniswap mobile app when you become eligible!",
        "unitagPlaceholder": "username"
      },
      "landing": {
        "button": {
      ...
      "scan": {
        ...
        "otp": {
          ...
          "failed": "Failed attempts: {{number}}",
          "subtitle": "Check your Uniswap mobile app for the 6-character code",
          "title": "Enter one-time code"
        },
        "subtitle": "Scan the QR code with the Uniswap mobile app to begin importing your wallet.",
        "title": "Import wallet from the app"
      },
      "security": {
        "alert": {
          "biometrics": {
    ...
    "qrScanner": {
      ...
      "wallet": {
        "title": "Uniswap Wallet supports tokens on Ethereum, Polygon, Arbitrum, Optimism, Base, Blast, and BNB Chain. Right now, we only support NFTs on Ethereum."
      }
    },
    "scantastic": {
      "code": {
      ...
      "confirmation": {
        ...
        "subtitle": "Only continue if you are scanning a QR code from Uniswap Extension on a trusted device.",
        "title": "Are you trying to import your wallet?",
        "warning": "Beware of sites and apps impersonating Uniswap. Otherwise your wallet may be compromised."
      },
      "error": {
      ...
      "modal": {
        "notOnWaitlist": {
          "message": "In order to become eligible for the Uniswap Extension Beta, join the waitlist by claiming a uni.eth username",
          "title": "You’re not on the waitlist"
        },
        "onWaitlist": {
          "message": "We’ll notify you in the app when you become eligible to join the Uniswap Extension Beta.",
          "title": "You’re still on the waitlist"
        }
      }
    },
    "send": {
      ...
      "input": {
        "token": {
          "balance": {
            "title": "Balance: {{balance}} {{symbol}}"
          }
        }
      },
      "recipient": {
        "previous_one": "1 previous transfer",
        ...
        "warning": {
          "viewOnly": {
            "message": "Only send funds to this wallet if you have the recovery phrase or know the owner of the wallet.",
            "title": "You have this as a view-only wallet"
          }
        }
      },
      "recipientSelect": {
        "search": {
          "empty": {
            "message": "When you send tokens to a wallet address, they’ll show up here",
      ...
      "review": {
        "input": {
          "tokenAmount": {
            "title": "{{currencyAmount}} of {{currencySymbol}}"
          }
        },
        "modal": {
      ...
      "warning": {
        ...
        "erc20": {
          "message": "You are attempting to send funds to a token address. Sending crypto to this type of address may result in a permanent loss of funds.",
          "title": "This is a token address"
        },
        "insufficientFunds": {
    ...
    "settings": {
      ...
      "setting": {
        ...
        "biometrics": {
          ...
          "warning": {
            "message": {
              "android": "If you don’t turn on biometrics, anyone who gains access to your device can open Uniswap Wallet and make transactions.",
              "ios": "If you don’t turn on {{biometricsMethod}}, anyone who gains access to your device can open Uniswap Wallet and make transactions."
            },
            "title": "Are you sure?"
          }
        },
    ...
    "swap": {
      ...
      "warning": {
        ...
        "uniswapFee": {
          "message": {
            "default": "Fees are applied to ensure the best experience with Uniswap. There is no fee associated with this swap.",
            "included": "Fees are applied to ensure the best experience with Uniswap, and have already been factored into this quote."
          },
          "title": "Swap fee"
        },
        "viewOnly": {
    ...
    "walletConnect": {
      ...
      "pending": {
        "button": {
          "connect": "Connect",
          "scrollDown": "Scroll down to connect"
        },
      ...
      "request": {
        "button": {
          "scrollDown": "Scroll down to sign",
          "sign": "Sign"
        },
        "details": {
          "label": {
